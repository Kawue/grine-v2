...
def betweenness_centrality():
    ...
    if len(calculated_ranks['centrality']) == 0:
        ...
        calculated_ranks['centrality'] = map_tuple_list_to_name(centrality_per_node)
...
def degree():
    ...
    if len(calculated_ranks['degree']) == 0:
        ...
        calculated_ranks['degree'] = map_tuple_list_to_name(degree_per_node)
...
def cluster_coefficient():
    ...
    if len(calculated_ranks['cluster_coefficient']) == 0:
        ...
        calculated_ranks['cluster_coefficient'] = map_tuple_list_to_name(adj_cluster_coeff_per_node)
...
def between_group_degree():
    ...
    if len(calculated_ranks['between_group_degree']) == 0:
        ...
        calculated_ranks['between_group_degree'] = map_tuple_list_to_name(b_degree)
...
def average_weight_per_edge():
    ...
    if len(calculated_ranks['cluster_coefficient']) == 0:
        ...
        calculated_ranks['cluster_coefficient'] = map_tuple_list_to_name(degree_per_node)
    return calculated_ranks['cluster_coefficient']
...
def map_tuple_list_to_name(l):
    """
        map a tuple list to one value
    """
