...
For 1. we refer to our preprocessing pipeline [A Mad Pie](https://github.com/Kawue/amadpie/) . For a self written processing we refer to our [imzML-to-HDF5-Parser](https://github.com/Kawue/imzML-to-HDF5), which is based on the [pyImzML-Parser](https://github.com/alexandrovteam/pyimzML/blob/master/pyimzml/ImzMLParser.py) and [Pandas](https://pandas.pydata.org/) .
